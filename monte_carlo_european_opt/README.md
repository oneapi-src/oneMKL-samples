...
[Using the Monte Carlo method for simulating European options pricing](https://www.intel.com/content/www/us/en/docs/onemkl/cookbook/current/monte-carlo-simulating-european-options-pricing.html).
